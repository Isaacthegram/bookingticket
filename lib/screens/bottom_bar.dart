import 'package:booktickets/screens/profile.dart';
import 'package:booktickets/screens/search.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(FluentSystemIcons.ic_fluent_home_filled), label: 'Home'),
